        ...
        while ($fila = $resultado->fetch_array()) {
            ...
            switch ($funcionalidad) {
                case "Gestion Usuarios":
                    ?><li class="parent"><a href='../Controllers/USUARIO_Controller.php'><?php echo $strings['Gestión de Usuarios'] ?></a></li>
                    <ul>
                        <li><a href='../Controllers/USUARIO_Controller.php?id=2'><?php echo $strings['Gestión de Entrenadores'] ?></a></li>
                        <li><a href='../Controllers/USUARIO_Controller.php?id=3'><?php echo $strings['Gestión de Deportistas'] ?></a></li> 
                    </ul><?php
                    break;

                case "Gestion Actividades Grupales":
                    ?><li><span><a href='../Controllers/ACTIVIDADGRUPAL_Controller.php'><?php echo $strings['Gestión de Actividades Grupales'] ?></a></span></li> <?php
                    break;
...
function añadirFuncionalidadesNoLogin() {
    ...
    echo '<li role="presentation"><a href="">Gestion 7</a></li>';
    /*
      <li><a href='../Controllers/INSTALACIONES_Controller.php'><?php echo $strings['Gestión de Instalaciones'] ?></a></li><?php
      // break;
      //"GESTION ACTIVIDADES GRUPALES":
      ?><li class="parent"><a href='../Controllers/ACTIVIDAD_Controller.php'><?php echo $strings['Gestión de Usuarios'] ?></a></li>
      <ul>
      <li><a href='../Controllers/ACTIVIDAD_Controller.php?id=2'><?php echo $strings['Gestión de Entrenadores'] ?></a></li>
      <li><a href='../Controllers/ACTIVIDAD_Controller.php?id=3'><?php echo $strings['Gestión de Deportistas'] ?></a></li>
      </ul><?php
      // break;
     */
}
...
function showNavbar() {
    ...
    if (!isset($_SESSION['login'])) {
        ...
        //Con un foreach de cada permiso imprimimos la funcionalidad

        añadirFuncionalidades($_SESSION['login']);
