...
//VISTA PARA LA MODIFICACIÓN DE USUARIOS
    ...
    function render() {
        ...
        <div class="container" >
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel"><?php echo $strings['VerActividadesImpartidas']; ?></h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <select multiple class="form-control" id="sel2" name="asignacionTablas[]">
                                            <?php
                                            foreach ($this->datos['actividades'] as $valor) {
                                                echo '<option>' . ConsultarNombreActividadGrupal($valor['0']) . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div> 
            ...
            <form  id="form" name="form" action='ENTRENADOR_Controller.php'  method='post'   enctype="multipart/form-data">
                <div class="form-group" >
                    <label class="control-label" ><?php echo $strings['Ver Entrenador']; ?></label><br>
                </div>
                ...
                <br>
                <td><a data-toggle="modal" href="#myModal" ><button type="button" class="btn btn-success"><?php echo $strings['VerActividadesImpartidas']; ?></button></a>
                <br>
                <br>
