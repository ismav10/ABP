            ...
            <div class="container">
                ...
                <table class="table">
                    <thead class="thead-dark">
                        ...
                        <?php } else { ?>
                            <td><a data-toggle="modal" href="#myModal1" onclick="changeIdAction1('<?php echo $this->datos[$j]['userName'] ?>')"><button type="button" class="btn btn-success"><?php echo $strings['Asignar']; ?></button></a></td>
                                    <?php
                                }
                            }
                            ?>
