...
//VISTA PARA LISTAR TODOS LOS USUARIOS
    ...
    function render() {
        ...
        <div class="container">
            <?php
            $lista = array('userName', 'idActividadGrupal', 'estado');
            ?>
                ...
                <div class="col-lg-12">
                    <table class="table">
                        <thead class="thead-dark">
                            ...
                            <td><button type="button" class="btn btn-success"><a href='INSCRIPCION_Controller.php?idInscripcion=<?php echo $this->datos[$j]['idInscripcion'] . '&accion=' . $strings['Aceptar']; ?>'><?php echo $strings['Aceptar']; ?></a></button></td>
